...
.pg-share{display:inline-flex;align-items:center;text-decoration:none;padding:12px 17px;border-radius:999px;font-family:var(--disp);font-weight:700;font-size:12px;letter-spacing:.06em;text-transform:uppercase;}
.pg-share.primary{background:var(--sage);color:var(--navy);} .pg-share.dark{background:var(--navy);color:var(--cream);}
                  ...
                  {referralLink && (
                    <>
                      ...
                      <div className="pg-shares">
                        <a className="pg-share primary" href={`sms:?&body=${encMsg}%20${encLink}`}>Text</a>
                        <a className="pg-share dark" target="_blank" rel="noreferrer" href={`https://www.facebook.com/sharer/sharer.php?u=${encLink}`}>Facebook</a>
                        <a className="pg-share dark" href={`mailto:?subject=${encodeURIComponent('You should enter this')}&body=${encMsg}%20${encLink}`}>Email</a>
                        <a className="pg-share dark" target="_blank" rel="noreferrer" href={`https://twitter.com/intent/tweet?text=${encMsg}&url=${encLink}`}>X</a>
                      </div>
                    </>
                  )}
